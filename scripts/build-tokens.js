...
w('')
w('  /* 감성미식 BIZ 브랜드 색상 (Figma 정확값) */')
w(cssLine('--color-brand-primary', 'brand.primary'))
w(cssLine('--color-brand-primary-dark', 'brand.primary-dark'))
w(cssLine('--color-brand-surface-muted', 'brand.surface-muted'))
w(cssLine('--color-brand-text', 'brand.text'))
w(cssLine('--color-brand-text-muted', 'brand.text-muted'))
w(cssLine('--color-brand-text-secondary', 'brand.text-secondary'))
w(cssLine('--color-brand-bg', 'brand.bg'))
w(cssLine('--color-brand-primary-soft', 'brand.primary-soft'))
w(cssLine('--color-brand-accent-warm', 'brand.accent-warm'))
w(cssLine('--color-brand-icon-muted', 'brand.icon-muted'))
w(cssLine('--color-brand-icon-subtle', 'brand.icon-subtle'))
w(cssLine('--color-brand-text-subtle', 'brand.text-subtle'))
w(cssLine('--color-brand-overlay-scrim', 'brand.overlay-scrim'))
w(cssLine('--color-brand-status-error', 'brand.status-error'))
w(cssLine('--color-brand-canvas-dark', 'brand.canvas-dark'))
w(cssLine('--color-brand-text-primary-light', 'brand.text-primary-light'))
w('')
...
;[
  ...
  'brand-primary', 'brand-primary-dark', 'brand-surface-muted',
  'brand-text', 'brand-text-muted', 'brand-text-secondary', 'brand-bg',
  'brand-primary-soft', 'brand-accent-warm', 'brand-icon-muted', 'brand-icon-subtle',
  'brand-text-subtle', 'brand-overlay-scrim', 'brand-status-error', 'brand-canvas-dark',
  'brand-text-primary-light',
